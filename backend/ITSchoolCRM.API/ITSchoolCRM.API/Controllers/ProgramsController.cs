...
public class ProgramsController : ControllerBase
{
    ...
    [HttpGet("{id:int}")]
    [Authorize(Policy = Policies.UserAccess)]
    public async Task<ActionResult<ProgramDto>> GetById(
        int id,
        CancellationToken cancellationToken)
    {
        var program =
    ...
    [HttpGet("active")]
    [Authorize(Policy = Policies.UserAccess)]
    public async Task<ActionResult<List<ProgramDto>>> GetActive(
        [FromQuery] int? directionId,
        CancellationToken cancellationToken)
    {
        var programs =
    ...
    [HttpGet("search")]
    [Authorize(Policy = Policies.UserAccess)]
    public async Task<ActionResult<List<ProgramDto>>> Search(
