...
namespace ITSchoolCRM.API.Integrations.Website.Services
{
    ...
    public class MockWebsiteIntegrationService : IWebsiteIntegrationService
    {
        ...
        public MockWebsiteIntegrationService(
            IHttpClientFactory httpClientFactory,
            IOptions<WebsiteIntegrationOptions> options,
            ILogger<MockWebsiteIntegrationService> logger)
        {
        ...
        public async Task<List<WebsiteApplicationDto>> GetApplicationsAsync(
            CancellationToken cancellationToken)
        {
            var applications =
                await SendAsync<List<WebsiteApplicationDto>>(
                    HttpMethod.Get,
                    "api/mock-website/applications",
                    payload: null,
                    cancellationToken);
                ...
                try
                {
                    ...
                    if (!response.IsSuccessStatusCode)
                    {
                        ...
                        throw new IntegrationException(
                            IntegrationErrorCodes.WebsiteBadResponse,
