...
{
    Task<string> RegisterAsync(RegisterDto dto, CancellationToken cancellationToken);

    Task<AuthTokenDto?> LoginAsync(LoginDto dto, CancellationToken cancellationToken);
